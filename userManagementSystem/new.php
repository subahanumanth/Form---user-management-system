...
<center><span class="large">Area Of Intrest</span> &ensp;<?php include("areaOfIntrest.php"); ?><span style="color:red;"><?php echo $error['areaOfIntrestError']; ?></span></center><br><br>
...
<center><span class="large">Confirm Password</span> &ensp; <input type="password" name="cpassword" ><span style="color:red;"><?php echo $error['cpasswordError']; ?></span>&ensp;</center><br><br>
