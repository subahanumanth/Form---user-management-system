...
<form method="post">
<button name="add">Add Details Of Graduation</button>
</form>
</html>
<?php
if(isset($_POST['add'])) {
    ?>
    <html><form method="post"><input type="text" name="bg" style="margin-left:465px;" placeholder="Details Of Graduation"><br><br><input type="submit" name="submit" id="submit"></form></html>
<?php
}
?>
